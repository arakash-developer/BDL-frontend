...
const Navbar = ({ className, click, menu }) => {
  ...
  return (
    <div className={`${className} flex items-center justify-between h-[4%] md:rounded-b-2xl relative z-30`}>
      <Link
        className="!flex items-center justify-center  bg-[#000000] w-[180px] h-[40px] !rounded-full text-xs relative gemini-thin-border"
        to="/">
        <img className="h-[25px] w-[30px] drop-shadow-custom" src="/assets/bdl.png" alt="" />
      </Link>
      ...
      <div className=" bg-[#000000] w-[175px] h-[40px] !rounded-full relative flex justify-center items-center gemini-thin-border">
        {menu ? (
          ...
          <Link className="w-full h-full flex justify-center items-center text-[#F15B26]" to="/menu">
